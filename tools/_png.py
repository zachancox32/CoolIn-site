# -*- coding: utf-8 -*-
"""PNG read, write and box filter resize, standard library only.

Lifted out of make-logos.py when the favicon.ico job needed the same three
functions. Nothing here knows about the brand, so both tools share it rather
than keeping two copies that drift apart.
"""
import struct, zlib
